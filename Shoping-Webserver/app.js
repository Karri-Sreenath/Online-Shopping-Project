...
var validateUserCredentialsRouter = require('./routes/validateUserCredentials');
var getProductDetailsRouter = require('./routes/getProductDetails');
var newUserSignupRouter = require("./routes/newUserSignup");

var app = express();
app.use(cors()); // enable CORS for all routes/domains
...
app.use('/validate/user', validateUserCredentialsRouter);
